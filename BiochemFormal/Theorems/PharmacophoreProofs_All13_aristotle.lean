...
This project request had uuid: b9ad0ee8-32f0-489e-98e0-6efffb928413
-/
...
Unexpected axioms were added during verification: ['harmonicSorry630748', 'BiochemFormal.amoxicillin_distance_too_small']-/
/-!
...
Note: Expected a function because this term is being applied to the argument
  amoxicillin
Unknown identifier `distance_violation_exclusion`
...
-- Aristotle: please verify 3.75 < 5.0 contradicts h_min
...
Unknown identifier `doxycycline.aromatic_rings`
Unknown identifier `doxycycline.basic_nitrogens`
Function expected at
  aromatic_nitrogen_distance
but this term has type
  ?m.1
...
Unexpected name `BiochemFormal` after `end`: The current section is unnamed

Hint: Delete the name `BiochemFormal` to end the current unnamed scope; outer named scopes can then be closed using additional `end` command(s):
  end ̵B̵i̵o̵c̵h̵e̵m̵F̵o̵r̵m̵a̵l̵-/
-- Aristotle: please verify 7.65 > 7.0 contradicts h_max
